...
class Config:
    ...
    def __init__(self) -> None:
        ...
        def __init__(self) -> None:
           """Initialize the Config class"""
       self.workspace_path = os.getenv("WORKSPACE_PATH", "/path/to/my_script_directory")
         os.environ["RESTRICT_TO_WORKSPACE"] = "True"
        ...
        self.elevenlabs_voice_id = os.getenv
            "ELEVENLABS_VOICE_ID", "b5b25d76abcc3257e7eb69bfe6aebcb0"
        # ELEVENLABS_VOICE_1_ID is deprecated and included for backwards-compatibility
        self.elevenlabs_voice_id = os.getenv(
            "ELEVENLABS_VOICE_ID", os.getenv("21m00Tcm4TlvDq8ikWAM")
        )
